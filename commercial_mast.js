...
function Bindagencyname(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtagncy") {
        ...
        var PEXTRA1 = "";
        var PEXTRA2 = "";
        commercial_mast.Bindagenyname(PCOMP_CODE, PCENT_CODE, PDESC, PSEACH, PEXTRA, PEXTRA1, PEXTRA2, bindagency_callback);
...
function Bindclient(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtclint") {
        ...
        var PEXTRA1 = "";
        var PEXTRA2 = "";
        commercial_mast.Bindclientname(PCOMP_CODE, PCENT_CODE, PDESC, PSEACH, PEXTRA, PEXTRA1, PEXTRA2, bindclient_callback);
