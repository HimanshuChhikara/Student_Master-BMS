...
function Bindclient(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtCilentName") {
        ...
        var PEXTRA1 = "";
        var PEXTRA2 = "";
        cancel_bill_d.Bindclientname(PCOMP_CODE, PCENT_CODE, PDESC, PSEACH, PEXTRA, PEXTRA1, PEXTRA2, bindclient_callback);
...
function Bindagencyname(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtAgencyName") {
        ...
        var PEXTRA1 = "";
        var PEXTRA2 = "";
        cancel_bill_d.Bindagenyname(PCOMP_CODE, PCENT_CODE, PDESC, PSEACH, PEXTRA, PEXTRA1, PEXTRA2, bindagency_callback);
...
function Bindexcutive(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtExecutive") {
        ...
        var PEXTRA1 = "";
        var PEXTRA2 = "";
        cancel_bill_d.excutive(PCOMP_CODE, PDESC, PSEACH, PEXTRA, PEXTRA1, PEXTRA2, bindexcutive_callback);
...
function Entertabfun(event) {
    ...
    if (key == 13) {
        ...
        if (document.activeElement.id == "txtExecutive") {
            if (document.getElementById("divexcutive").style.display != "none") {
                filllexcutive(event);
            }
        ...
        if (document.activeElement.id == "txtCilentName") {
            ...
            if (document.getElementById('txtfct').disabled == false)
                document.getElementById('txtfct').focus();
            return false;
        }

        if (document.activeElement.id == "txtfct") {

            if (document.getElementById('txtfacname').disabled == false)
                document.getElementById('txtfacname').focus();
            return false;
        }
        if (document.activeElement.id == "txtfacname") {
        ...
        if (document.activeElement.id == "txtToDate") {
            ...
            if (document.getElementById('drpbillstatus').disabled == false)
                document.getElementById('drpbillstatus').focus();
            return false;
        }
        if (document.activeElement.id == "drpbillstatus") {
        ...
        if (document.activeElement.id == "drpRepDes") {
            if (document.getElementById('btnrureport').disabled == false)
                document.getElementById('btnrureport').focus();
            return false;
        }
...
function Bindteam(event) {
    ...
    if (key == 113 && document.activeElement.id == "txtTeamName") {
        ...
        cancel_bill_d.teamname(pcompcode, pexeteam, bindteamname_callback);
